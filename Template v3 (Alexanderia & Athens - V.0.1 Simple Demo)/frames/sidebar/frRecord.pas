...
procedure TFRecord.Back;
begin
  Frame.Back;
end;

procedure TFRecord.btnMenuClick(Sender: TObject);
begin
  HelperFunction.ShowSidebar;
end;

constructor TFRecord.Create(AOwner: TComponent);
begin
  inherited;

end;

procedure TFRecord.Label1Click(Sender: TObject);
begin
  Frame.GoFrame(View.HOME);
end;

procedure TFRecord.Show;
begin
  HelperFunction.SetSelectedMenuSidebar(View.RECORDDATA);
end;
